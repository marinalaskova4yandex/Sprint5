...
class TestAuthorization:
    ...
    def test_login_via_personal_profile_button(self, driver, registered_user):
        ...
        logging.info("Выполняем переход через кнопку «Личный кабинет»")
        assert True
        logging.info("Выполнен вход через кнопку «Личный кабинет».")