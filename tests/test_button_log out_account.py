...
def test_user_logout_from_personal_profile(driver, authorized_user):
    ...
    print("Выполнен выход по кнопке «Выйти» в личном кабинете.")

    # Пауза перед автоматическим закрытием браузера фикстурой driver
    time.sleep(3)